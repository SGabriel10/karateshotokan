...
<div class="row" id='column-id'>
  <div class="column">
    <div class="card">
      <img src="<?php echo base_url('assets/juan.jpg'); ?>" id="card-targets">
      <div class="container">
        <h2>Juan R. Cubas</h2>
  ...
  <div class="column">
    <div class="card">
    <img src="<?php echo base_url('assets/norma.jpg'); ?>" id="card-targets"> 
      <div class="container">
        <h2>Norma</h2>
  ...
  <div class="column">
    <div class="card">
      <img src="<?php echo base_url('assets/build-page.jpg'); ?>" id="card-targets"> 
      <div class="container">
        <h2>Juanito Perez</h2>
